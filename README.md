...
This repository holds the source files that are used to build and maintain the [rlem-workshop.net](www.rlem-workshop.net/) website. The website theme is taken from [jekyll-theme-conference](https://github.com/DigitaleGesellschaft/jekyll-theme-conference)
...
The website is located at [rlem-workshop.net](www.rlem-workshop.net/) and uses GitHub Actions for continuous deployment.
